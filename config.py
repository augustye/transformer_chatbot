...
def get_model_config():
    ...
    config = AttrDict({'bpe_vocab_path': '/root/git/transformer_chatbot/parameters/bpe.vocab',
                       'bpe_codes_path': '/root/git/transformer_chatbot/parameters/bpe.code',
                       'checkpoint_path': '/root/git/transformer_chatbot/checkpoints/last_checkpoint', 
